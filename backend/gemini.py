...
origins = ["http://127.0.0.1:5500","http://localhost:5500","http://localhost:5501","http://localhost:5502"]
app = FastAPI()
app.add_middleware(
    CORSMiddleware,
...
def getStory(categ: str):
    res = model.generate_content(f"get me short random {categ} story in 300 words ")
    return res.text
